  ...
  public BookmarkDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBookmark = new EntityInsertionAdapter<Bookmark>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `Bookmark` (`id`,`placeId`,`name`,`address`,`latitude`,`longitude`,`phone`) VALUES (?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfBookmark = new EntityDeletionOrUpdateAdapter<Bookmark>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR REPLACE `Bookmark` SET `id` = ?,`placeId` = ?,`name` = ?,`address` = ?,`latitude` = ?,`longitude` = ?,`phone` = ? WHERE `id` = ?";
      }
      ...
      public List<Bookmark> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Bookmark(_tmpId,_tmpPlaceId,_tmpName,_tmpAddress,_tmpLatitude,_tmpLongitude,_tmpPhone);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Bookmark loadBookmark(final long bookmarkId) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result = new Bookmark(_tmpId,_tmpPlaceId,_tmpName,_tmpAddress,_tmpLatitude,_tmpLongitude,_tmpPhone);
      } else {
        _result = null;
      }
      return _result;
